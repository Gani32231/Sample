...
function Enquirew() {
    return (
        ...
        <div className="es__hgp__box">
            ...
            <a href="/enquires">
            <svg className="enq__box1" width="352" height="338" viewBox="0 0 352 338" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect x="2.5" y="2.5" width="347" height="333" rx="7.5" fill="white" stroke="#DB1505" stroke-width="5"/>
       

            </svg>
            
            <svg className="enq__box1ed" width="246" height="144" viewBox="0 0 246 144" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <p className="enq__nam1" >Student</p>
            </a>
            ...
            <svg className="enq__box2s1" width="79" height="79" viewBox="0 0 79 79" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg className="enq__box2s2" width="104" height="72" viewBox="0 0 104 72" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg className="enq__box2s3" width="102" height="83" viewBox="0 0 102 83" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <p className="enq__nam2" >Working Women</p>
            ...
            <p className="enq__nam3" >Full Name*</p>
            <input type="text" className="enq__inp1" required ></input>
            <p className="enq__nam4" >Adhar Number*</p>
            <input type="text" className="enq__inp2" required></input>
            <p className="enq__nam5" >Your age</p>
            <input type="text" className="enq__inp3"></input>
            <p className="enq__nam6" >Contact Number*</p>
            <input type="text" className="enq__inp4"></input>
            <p className="enq__nam7">Father Name*</p>
            
            <input type="text" className="enq__inp5"></input>
            <p className="enq__nam8">Matitial Status*</p>
            <input type="text" className="enq__inp6"></input>
            <p className="enq__nam9">Working as*</p>
            <input type="text" className="enq__inp7"></input>
            <p className="enq__nam10">Working Place/Company Details**</p>
            <input type="text" className="enq__inp8"></input>
            <p className="enq__nam11">Interested Bike*</p>
            <input type="text" className="enq__inp9"></input>
            <p className="enq__nam14">Email ID*</p>
            <input type="text" className="enq__inp12"></input>
            <p className="enq__nam12">Alternate Contact Num </p>
            <input type="text" className="enq__inp10"></input>
            <p className="enq__nam13">Mother Name*</p>
            <input type="text" className="enq__inp11"></input>
            <p className="enq__nam15">Monthly Take Home Salary*      </p>
            <input type="text" className="enq__inp13"></input>
            <p className="enq__nam16">Working Since*</p>
            <input type="text" className="enq__inp14"></input>
            <p className="enq__nam17">Model Number*</p>
            <input type="text" className="enq__inp15"></input>
            <p className="enq__nam18">Whatsapp Number* </p>
            <input type="text" className="enq__inp16"></input>
            <p className="enq__nam19">Present Address*      </p>
            <input type="text" className="enq__inp17"></input>
            <p className="enq__nam20">Permanent Address*</p>
            <input type="text" className="enq__inp18"></input>
            <input type="checkbox" className="enq__cb"/>
            <p className="enq__nam21"><u>By clicking this you consent to our term and conditions</u></p>
            <a href="/">
            <button className="enq__btn">
                Submit
            </button>
            </a>
        </div>
